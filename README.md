...
Arquivo simples, com somente 1 função que imprime o "Hello World" na tela quando executado<br/>
...
treino de declaração das mesmas.<br/>
...
**TIPOS DE DADOS**: Possui um programa onde aloco diversos prints com diversos tipos de dados para conferência dos mesmos<br/>
...
e a utilização do operador '//' para retorno de inteiros para divisão de inteiros por inteiros<br/>
...
a outra, com inputs, função e estrutura de condição<br/>
...
A mesma recebe o peso e altura por parâmetro e retorna o IMC da pessoa.<br/>
...
dos valores X' e X'' (X linha e X 2 linhas) e retorna esse valor.<br/>
...
e retornar o resultado.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/CONDICIONAIS

## ESTRUTURAS DE REPETIÇÃO
Pasta com somente 1 programa com diversas aplicações de estrutura de repetição, onde tento 
aplicar os conceitos aprendidos ao longo do treinamento.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/ESTRUTURAS_REPETICAO
...
Caso haja repetição maior que 2, o mesmo reescreve a string, adicionando um máximo de 2 caracteres.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/EXERCITANDO_LOP_COND

## LISTAS
Pasta com somente 1 programa onde lanço todos os métodos de lista e os treino para melhor aprendizado e compreensão, descrevendo os retornos e ações de cada um.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/LISTAS

## EXERCITANDO LISTAS
Pasta contendo somente 1 programa onde exercito com várias propostas diferentes a utilização de listas e a "fabricação" de listas<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/EXERCITANDO_LISTAS

## DICIONÁRIOS
Pasta contendo somente 1 programa onde lanço os métodos e crio vários dicionários para melhor aprender e por em prática a utilização dos dicionários<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/DICIONARIOS

## EXERCITANDO DICIONÁRIOS
Pasta contendo somente 1 programa onde exercito com várias proposta diferentes a utilização de dicionários e a "fabricação" dos mesmos<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/EXERCITANDO_DIC

## TUPLAS
Pasta contendo somente 1 programa onde instancio uma tupla e faço uma pequena interação com a mesma.
Deixo algumas descrições que são necessárias à utilização da mesma, assim como a principal diferença entre tuplas e listas e dicionários.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/TUPLAS

## EXERCITANDO TUPLAS
Pasta contendo somente 1 programa onde exercito todo o aprendizado por mim adquirido em relação à tuplas. Utilizo dos métodos dispostos para a mesma, faço algumas iterações e retornos.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/EXERCITANDO_TUPLAS

## CONJUNTOS
Pasta contendo somente 1 programa onde exercito todo o aprendizado sobre conjuntos com vários exercícios.<br/>
Link direto: https://github.com/LucasDeleonPaz/Introducao_Data_Science/tree/main/CONJUNTOS
